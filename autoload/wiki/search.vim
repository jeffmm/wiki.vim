...
function! wiki#search#rg_text(fullscreen, pattern, dir)
  call fzf#vim#grep(
...
"
" Search all text that match pattern in files within dir
function! wiki#search#rg_text_files(fullscreen, pattern, dir)
  call fzf#vim#grep(
  \   'rg --column --line-number --smart-case --no-heading --color=always ' . shellescape(a:pattern) . ' ' . fnameescape(a:dir), 1,
...
function! wiki#search#rg_files(fullscreen, dir, pattern)
...
function! wiki#search#insert_link(fullscreen) abort
